...
CREATE TABLE IF NOT EXISTS bronze.velib_stations (
    ...
    name TEXT,
    capacity SMALLINT,
    numdockavailable SMALLINT,
    numbikeavailable SMALLINT,
    mechanical SMALLINT,
    ebike SMALLINT,
...
CREATE INDEX IF NOT EXISTS idx_meteo_measured_at ON bronze.meteo_paris BRIN (measured_at);
